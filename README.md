...
git clone https://github.com/saraswathikasi/Gen-AI.git
cd GeminiNutri-AI
...
Default Prompt in Deployed App: In the deployed app, there is a default prompt provided below which you can modify on the streamlit site:
